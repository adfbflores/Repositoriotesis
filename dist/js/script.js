            ...
            success: function(resp) {
                if (resp) {
                    ...
                    if (resp.status == 'success') {
                        ...
                        var _frm = $('#login-frm')
                        var _msg = "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i> Su cuenta aún no está verificada.</div>"
                        _frm.prepend(_msg)
                        _frm.find('input').addClass('is-invalid')
                        $('[name="username"]').focus()
                    }
            ...
            success: function(resp) {
                if (resp) {
                    ...
                    if (resp.status == 'success') {
                        ...
                        var _frm = $('#clogin-frm')
                        var _msg = "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i> Código o contraseña incorrectos</div>"
                        _frm.prepend(_msg)
                        _frm.find('input').addClass('is-invalid')
                        $('[name="username"]').focus()
                    }
